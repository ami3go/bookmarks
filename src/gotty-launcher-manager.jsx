                    ...
                    {!draft ? (
                        ...
                        <Form id="gotty-launcher-form" onSubmit={save}>
                            ...
                            <FormGroup label="Application command" isRequired fieldId="gotty-launcher-command">
                                ...
                                <div className="bookmark-field-help">Examples: <code>/usr/bin/mc</code>, <code>/usr/bin/btop</code>, <code>/usr/bin/fish</code>, or another executable path. Absolute paths are recommended for launcher reliability. Use <code>{'{host}'}</code> for the Cockpit host name or IP address.</div>
                            </FormGroup>
